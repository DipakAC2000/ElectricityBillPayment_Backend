...
public class BillServiceImpl {
	...
	public Bill generateBill(Long consumerNumber) {
	    ...
	    Connection connection = optionalConnection.orElseThrow(() ->
	            new ConsumerNumberNotFoundException("Consumer not found for consumer number: " + consumerNumber));
	    ...
	    if (!latestReading.isEmpty()) {
	        ...
	        throw new ReadingNotFoundException("Invalid reading exception:");
	    }
	}
...
//
//		if (connection == null) {
//			throw new ConsumerNumberNotFoundException("Consumer not found for consumer number: " + consumerNumber);
//		}
//		else {
//			// Fetch the latest reading for the given consumerNumber from the repository
//			List<Reading> latestReading = readingRepository.findLatestReadingByConsumerNumber(consumerNumber);
//			System.out.println("...." + latestReading.get(0));
//
//			// Fetch the previous reading for the given consumerNumber from the repository
//			//	List<Reading> previousReading = readingRepository.findPreviousReadingByConsumerNumber(consumerNumber);
//			//System.out.println("......" + latestReading.get(1));
//
